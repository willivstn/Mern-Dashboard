  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        >
          <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:
          '#11142d'}}>Enter Property name</FormHelperText>
            <TextField
              fullWidth
              required
              id="outlined-basic"
          ...
          <FormControl>
            ...
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:
          '#11142d'}}>Enter Description</FormHelperText>
            <TextareaAutosize
            minRows={5}
            required
          ...
          <Stack direction="row" gap={4}>
            ...
            <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:
             '#11142d'}}>Enter Property price</FormHelperText>
            <TextField
              fullWidth
              required
              id="outlined-basic"
          ...
          <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:
             '#11142d'}}>Enter location</FormHelperText>
            <TextField
              fullWidth
              required
              id="outlined-basic"
